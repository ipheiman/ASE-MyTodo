...
function Leaderboard() {
    ...
    const data = [{name: "Denzel", score: 300, inc :  <FaArrowUp className="trash-btn text-success" style={{ position: "absolute", right: "100px", bottom: "10px"}} size = {30}/>},
    {name: "Jashini", score: 500, inc: <FaArrowUp className="trash-btn text-success" style={{ position: "absolute", right: "100px", bottom: "10px"}} size = {30}/>},
    {name: "Duc", score: 0, inc: <FaArrowDown className="trash-btn text-danger"  style={{ position: "absolute", right: "100px", bottom: "10px"}} size = {30}/>},
    {name: "Heiman", score: 500, inc: <FaArrowUp className="trash-btn text-success" style={{ position: "absolute", right: "100px", bottom: "10px"}} size = {30}/>},
