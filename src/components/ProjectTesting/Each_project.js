...
function Each_project(props) {
    ...
    return (
        <div>
            ...
            <div className="todo">
                <tr>
                    <td className={`todo-item ${props.todo.completed ? "completed" : ""}`}>{props.text}</td>
                    <td className={`todo-item ${props.todo.completed ? "completed" : ""}`}>{props.description}</td>
                    <td className={`todo-item ${props.todo.completed ? "completed" : ""}`}>{props.date}</td>
